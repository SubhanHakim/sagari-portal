<x-app-layout>
    <div class="py-12 bg-gradient-to-br from-indigo-200 via-blue-100 to-pink-100 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900 min-h-screen">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 grid grid-cols-1 md:grid-cols-3 gap-6">
            <div class="bg-white/80 dark:bg-gray-900/80 shadow-2xl rounded-2xl backdrop-blur-md border border-gray-200 dark:border-gray-800 overflow-hidden">
                <div class="p-6 text-gray-900 dark:text-gray-100 flex flex-col justify-center items-center gap-4">
                    ...
                    <div class="h-0.5 rounded-full w-full bg-gray-200 dark:bg-gray-700"></div>
                    <a href="{{ route('sso.app') }}" class="mt-2 px-4 py-2 rounded-lg bg-indigo-600 text-white hover:bg-indigo-700 transition">Masuk ke Aplikasi</a>
                </div>
            </div>
            <div class="bg-white/80 dark:bg-gray-900/80 shadow-2xl rounded-2xl backdrop-blur-md border border-gray-200 dark:border-gray-800 overflow-hidden">
                <div class="p-6 text-gray-900 dark:text-gray-100 flex flex-col justify-center items-center gap-4">
